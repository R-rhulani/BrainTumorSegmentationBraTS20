...
#
# test_image_flair = nib.load(TRAIN_DATASET_PATH + 'BraTS20_Training_225/BraTS20_Training_225_flair.nii').get_fdata()
...
# test_image_t1 = nib.load(TRAIN_DATASET_PATH + 'BraTS20_Training_225/BraTS20_Training_225_t1.nii').get_fdata()
# test_image_t1 = scaler.fit_transform(test_image_t1.reshape(-1, test_image_t1.shape[-1])).reshape(test_image_t1.shape)
#
# test_image_t1ce = nib.load(TRAIN_DATASET_PATH + 'BraTS20_Training_225/BraTS20_Training_225_t1ce.nii').get_fdata()
# test_image_t1ce = scaler.fit_transform(test_image_t1ce.reshape(-1, test_image_t1ce.shape[-1])).reshape(
#     test_image_t1ce.shape)
#
# test_image_t2 = nib.load(TRAIN_DATASET_PATH + 'BraTS20_Training_225/BraTS20_Training_225_t2.nii').get_fdata()
# test_image_t2 = scaler.fit_transform(test_image_t2.reshape(-1, test_image_t2.shape[-1])).reshape(test_image_t2.shape)
#
# test_mask = nib.load(TRAIN_DATASET_PATH + 'BraTS20_Training_225/BraTS20_Training_225_seg.nii').get_fdata()
