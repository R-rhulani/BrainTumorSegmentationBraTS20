...
#
#     result_depth = (x.shape[0] - 1) * stride_depth + kernel_depth
#     result_height = (x.shape[1] - 1) * stride_height + kernel_height
#     result_width = (x.shape[2] - 1) * stride_width + kernel_width
#
#     result = np.zeros((result_depth, result_height, result_width, out_channels))
#
#     for d in range(result_depth):
...
#             for w in range(result_width):
#                 for c in range(out_channels):
#                     result[d, h, w, c] = np.sum(
#                         x[d:d+kernel_depth:stride_depth, h:h+kernel_height:stride_height, w:w+kernel_width:stride_width, :] *
#                         kernel[:, :, :, c, np.newaxis]
#                     )
#
#     return result
...
def simple_unet_model(IMG_HEIGHT, IMG_WIDTH, IMG_DEPTH, IMG_CHANNELS, num_classes):
    ...
    # print("c5 shape after conv3d:", c5.shape)
    c5 = relu(c5)
    # print("c5 shape after relu:", c5.shape)
    c5 = dropout(c5, 0.3)  # Lowered dropout rate
    # print("c5 shape after dropout:", c5.shape)
    # print("c5 values after dropout:", c5)  # Print the values to check if they are all zeros
    # c5 = conv3d(c5, kernel_initializer)
    # print("c5 shape after second conv3d:", c5.shape)
    # print("c5 values after conv3d:", c5)
    # c5 = relu(c5)
    # print("c5 shape after second relu:", c5.shape)
    # print("c5 values after dropout:", c5)
    ...
    # cropped_c4 = c4[:u6.shape[0], :u6.shape[1], :u6.shape[2], :]
    # print("cropped_c4 shape after upsample:", cropped_c4.shape)
    # print("u6 shape after upsample:", u6.shape)
    # print("c4 shape before concatenate conv3d:", c4.shape)
    # u6 = concatenate([u6, cropped_c4], axis=3)
